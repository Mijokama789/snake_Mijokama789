...
/**
 * The {@code CirclePainter} paints a circle onto fields.
 *
 * @author max_mueller
 ...
 */
public class CirclePainter implements FieldPainter {

    private Color color = null;

    public CirclePainter(Color color) {
        this.color = Objects.requireNonNullElse(color, FieldPainters.DEFAULT_SHAPE_COLOR);
    }

    @Override
    public void paintField(int x, int y, int fieldSize, Graphics g) {
        g.setColor(color);
        g.fillOval(x * fieldSize, y * fieldSize, fieldSize, fieldSize);
    }
